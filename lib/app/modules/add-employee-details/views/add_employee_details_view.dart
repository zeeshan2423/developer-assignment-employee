...
class AddEmployeeDetailsView extends GetView<AddEmployeeDetailsController> {
  const AddEmployeeDetailsView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: ColorManager.white,
      appBar: WidgetManager.customAppBar(
        title: StringManager.addEmployee,
      ),
      body: Center(
        child: Form(
